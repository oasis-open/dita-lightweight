...
MDITA is not a new Markdown flavor. As a [Lightweight DITA](http://dita.xml.org/blog/overview-of-lightweight-dita-xdita-and-hdita) model, its purpose is to simplify the process of authoring technical content. MDITA tries to stick as close as possible to the [original Markdown syntax](http://daringfireball.net/projects/markdown/syntax) proposed by John Gruber; however, it acknowledges its limitations for structuring documentation beyond web articles. Thus, MDITA incorporates elements from John McFarlane's [Pandoc](http://johnmacfarlane.net/pandoc/) and [GitHub Flavored Markdown](https://help.github.com/articles/github-flavored-markdown/).
